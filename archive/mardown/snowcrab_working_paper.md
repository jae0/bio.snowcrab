...
include_graphics(  file.path( SCD, "assessments", year_assessment, "timeseries", "survey", "cw.male.mat.mean.pdf" )  )
...
include_graphics( file.path( SCD, 'assessments', year_assessment, 'timeseries', 'survey', 't.pdf') )
...
include_graphics( file.path( SCD, 'assessments', year_assessment, 'timeseries', 'temperature_bottom.pdf') )
