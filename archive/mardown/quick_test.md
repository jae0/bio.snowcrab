...
#     dev.args = list(type = "cairo"),
  ...
  sn_env = snowcrab_load_key_results_to_memory( year_assessment, years_model=p$fishery_model_years,  debugging=params$debugging, return_as_list=TRUE  ) 
...
include_graphics( file.path( SCD, 'assessments', year_assessment, 'timeseries', 'survey', 'ms.no.10.pdf') )
