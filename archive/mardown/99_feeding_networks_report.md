...
# for html documents including presentations:
  make quarto FN=99_feeding_networks_report YR=2023 SOURCE=~/bio/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/assessments DOCEXTENSION=html  PARAMS="-P year_assessment:2024"  # {via Quarto}


# for presentations to PDF (via beamer):
# note: section separation with '#' can confuse rmarkdown
  
  make rmarkdown FN=99_feeding_networks_report YR=2023 SOURCE=~/bio/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/assessments DOCTYPE=pdf_document  DOCEXTENSION=pdf  # {via Rmarkdown}
