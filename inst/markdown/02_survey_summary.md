...
species_code = striped_atl_wolffish
...
#| eval: true
#| output: true
#| fig-cap: "Mean density of Smooth skate purse log$_{10}$(no/km$^2$) from surveys with 1 SE."
#| fig-dpi: 144
#| fig-height: 4 

ts_outdir = file.path( p$annual.results, "timeseries", "survey", params$mau)

species_code = skate_purses_smooth_skate
...
#| echo: false 
#| layout-ncol: 2
#| fig-cap: Smooth skate purse, density; log$_{10}$(no/km$^2$). 
#| fig-subcap: 
#|   - ""
#|   - ""
#|   - ""
