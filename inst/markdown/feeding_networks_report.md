...
This is a Markdown document 
  ...
  make quarto FN=feeding_networks_report.md YR=2024 DATADIR=~/bio.data/bio.snowcrab DOCTYPE=html  PARAMS="-P year_assessment:2024"  --directory=~/bio/bio.snowcrab/inst/markdown 
