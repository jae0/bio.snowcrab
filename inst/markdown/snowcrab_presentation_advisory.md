...
This is a Markdown/Quarto document  
  ...
  # {via Quarto}
  make quarto FN=snowcrab_presentation_advisory YR=2024 SOURCE=~/projects/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/assessments DOCTYPE=beamer  DOCEXTENSION=pdf  PARAMS="-P year_assessment:2024" 

 
  make quarto FN=snowcrab_presentation_advisory YR=2024 SOURCE=~/bio/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/assessments  DOCEXTENSION=html  PARAMS="-P year_assessment:2024"  # {via Quarto}


  # to make a msoffice docx:

  cd ~/bio/bio.snowcrab/inst/markdown

  make quarto FN=snowcrab_presentation_advisory YR=2024 SOURCE=~/bio/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/assessments  DOCEXTENSION=html DOCTYPE=revealjs  PARAMS="-P year_assessment:2024"  # {via Quarto}
    
  make quarto FN=snowcrab_presentation_advisory YR=2024 SOURCE=~/bio/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/assessments  DOCEXTENSION=pdf DOCTYPE=beamer  PARAMS="-P year_assessment:2024"  # {via Quarto}
