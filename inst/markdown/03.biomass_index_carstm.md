...
This is a Markdown document ... To create HTML or PDF, etc, run: 
  ...
  make quarto FN=03.biomass_index_carstm YR=2023 SOURCE=~/projects/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/assessments # {via Quarto}

  make rmarkdown FN=03.biomass_index_carstm YR=2023 SOURCE=~/projects/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/assessments {via Rmarkdown}
...
```r
  ...
  # saves in carstm_directory = file.path( pN$modeldir, pN$carstm_model_label )
