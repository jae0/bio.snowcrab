...
```r
    ...
    carstm_posterior_predictive_check(p=p, M=M[ iq, ]  )
    ...
    # posterior predictive check
    carstm_posterior_predictive_check(p=p, M=M[ iw, ]  )
  ...
  # some maps and plots
    ...
    for (vns in c( "number", "meansize", "habitat") ) {
      ...
      carstm_plot_map( p, outputdir, fn_root_prefix , additional_features, 
        toplot="random_spatial", probs=c(0, 0.975) ) 
