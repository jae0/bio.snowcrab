...
This is a RMarkdown document designed to render a DOCX document. Run:

  make snowcrab_sar YR=2023 SOURCE~/bio/bio.snowcrab/inst/markdown WK=~/bio/bio.data/bio.snowcrab/reports 
