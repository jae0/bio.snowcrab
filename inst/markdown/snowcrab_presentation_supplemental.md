...
make quarto FN=snowcrab_presentation_supplemental.md DOCTYPE=html  PARAMS="-P year_assessment:2025 -P todo:[fishery_results,survey,ecosystem,fishery_model]"  --directory=~/bio/bio.snowcrab/inst/markdown
