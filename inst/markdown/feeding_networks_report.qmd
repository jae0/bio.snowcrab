...
This is a Quarto document designed to generate an HTML file. 

  make feeding_networks_report YR=2023 SOURCE~/bio/bio.snowcrab/inst/markdown WK=~/bio/bio.data/bio.snowcrab/reports 
...
ggplot() + 
    ...
    theme(legend.position.inside =c(0.16, 0.65), legend.title=element_blank(), legend.text=element_text(size=6.0) 
 ) 
```
...
ggplot() + 
    ...
    theme(legend.position.inside =c(0.16, 0.725), legend.title=element_blank(), legend.text=element_text(size=6.0) )
