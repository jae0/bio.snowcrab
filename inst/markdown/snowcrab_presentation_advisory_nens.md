...
make quarto FN=snowcrab_presentation_advisory_nens.md DOCTYPE=html  PARAMS="-P year_assessment:2025 -P todo:[fishery_results,survey,ecosystem,fishery_model]"  --directory=~/bio/bio.snowcrab/inst/markdown
...
#| fig-height: 4
#| fig.show: hold
#| fig-cap: "Reference Points (fishing mortality and modelled biomass) from the Fishery Model, for N-ENS in Spring. The large yellow dot indicates most recent year and the 95\\% CI. Not: the model does not account for illegal and unreported landings, and interspecific interactions."
# #| fig-subcap:
# #|   - "N-ENS"
# #|   - "S-ENS"
# #|   - "4X"
