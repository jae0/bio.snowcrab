...
#| label: load-data-from-R
  ...
  if (0) {
    params = params_debug  # to enter debug directly ... 
  }
  ...
  if (0) {
   # to delete
    ...
    reg_labels = maus[["labels"]]  # formatted for label
    maus[["n"]] = maus[["n"]]
  }
  ...
  if (file.exists(data_dump_file))  {
    ...
    if ( "fishery_results" %in% todo ) {
      ...
      dt =  dt[,c( mau, "yr", "Licenses", "TAC", "landings", "effort", "cpue")] 
