...
loc = file.path( data_root, "aegis", "temperature", "modelled", "1999_present" )
...
loc = file.path( data_root, "aegis", "speciescomposition", "modelled", "1999_present" )
fn1 = file.path( loc, "posterior_predictive_check_pca1.png" )
fn2 = file.path( loc, "posterior_predictive_check_pca2.png" )
fn3 = file.path( loc, "posterior_predictive_check_pca3.png" )
knitr::include_graphics( c(fn1, fn2 ) ) 
``` 
...
loc = file.path( data_root, "bio.snowcrab", "modelled", "1999_present_fb" )
fn1 = file.path( loc, "predicted.numerical.densities", "posterior_predictive_check.png" )
fn2 = file.path( loc, "predicted.meansize", "posterior_predictive_check.png" )
fn3 = file.path( loc, "predicted.presence_absence", "posterior_predictive_check.png" )
