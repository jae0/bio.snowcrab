...
```{r setup, include=FALSE}
  ...
  if (0) {
    ...
    # pm = list( year.assessment=year.assessment, media_loc=media_loc, debugging=TRUE, loc_dde=loc_dde ) # skip reload of julia results (slow)
  ...
  bio.snowcrab::snowcrab_load_key_results_to_memory( year.assessment, debugging=params$debugging, loc_dde=params$loc_dde ) 
