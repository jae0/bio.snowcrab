---
title: "Snow Crab, Scotian Shelf, Canada (NAFO Div. 4VWX) in 2022"
...
params:
  ...
  media_loc: "/home/jae/projects/snowcrab_presentations/media"
  debugging: FALSE
--- 

<!--- Preamble: set up R-environment
    # to generate output:
    year.assessment = 2023
    ID = "snowcrab_presentation"

    loc = file.path( Sys.getenv("HOME"), "projects", "snowcrab_presentations"  )
    ...
    # system( paste( "libreoffice -o ", gsub( "\\.rmd$", ".odt", fn_rap_rmd ), "&" ) )
--->
...
#     dev.args = list(type = "cairo"),
  ...
  bio.snowcrab::snowcrab_load_key_results_to_memory( year.assessment ) 
...
fn1=file.path( loc, "growth_summary.png" )
...
\begin{scriptsize}
```{r meansize-male-mat, out.width='50%', echo=FALSE, fig.align='center', fig.cap = 'Mean size of mature male Snow Crab (CW; mm) from surveys with 95\\% Confidence Intervals'}
...
include_graphics(  file.path( SCD, "assessments", year.assessment, "figures", "size.freq", "survey", "direct", "male.denl.png" )  )
...
include_graphics(  file.path( SCD, "assessments", year.assessment, "figures", "size.freq", "survey", "direct", "female.denl.png" )  )
...
```{r habitat3, echo=FALSE, out.width='30%', fig.align='center', fig.show='hold',  fig.cap = 'Persistent habitat.' }
...
```{r bottom-temperatures-survey2, out.width='50%', echo=FALSE, fig.align='center', fig.cap = 'Annual variations in bottom temperature observed during the Snow Crab survey. The horizontal (black) line indicates the long-term, median temperature within each subarea. Error bars represent standard errors. Subset' }
...
```{r sizefeq-male-oneoff, out.width='35%', echo=FALSE, fig.align='center', fig.cap = 'Subset: 2017-2022'}
...
```{r sizefeq-female-oneoff, out.width='35%', echo=FALSE, fig.align='center', fig.cap = 'Subset: 2017-2022'}
