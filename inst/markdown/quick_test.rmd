...
|----- | ----- | ----- | ----- |
| |  |  |  |
|Prefishery Biomass (t)  | `r round(B_north[t1], 2)` (`r round(B_north_sd[t1], 2)`) | `r round(B_south[t1], 2)`  (`r round(B_south_sd[t1], 2)`) | `r round(B_4x[t1], 2)`  (`r round(B_4x_sd[t1], 2)`)  |
|Fishing Mortality       | `r round(FM_north[t1], 3)` (`r round(FM_north_sd[t1], 3)`) | `r round(FM_south[t1], 3)` (`r round(FM_south_sd[t1], 3)`) | `r round(FM_4x[t1], 3)` (`r round(FM_4x_sd[t1], 3)`) |
|r       | `r round(r_north[t1], 3)` (`r round(r_north_sd[t1], 3)`) | `r round(r_south[t1], 3)` (`r round(r_south_sd[t1], 3)`) | `r round(r_4x[t1], 3)` (`r round(r_4x_sd[t1], 3)`) |
|K       | `r round(K_north[t1], 3)` (`r round(K_north_sd[t1], 3)`) | `r round(K_south[t1], 3)` (`r round(K_south_sd[t1], 3)`) | `r round(K_4x[t1], 3)` (`r round(K_4x_sd[t1], 3)`) |
|q       | `r round(q_north[t1], 3)` (`r round(q_north_sd[t1], 3)`) | `r round(q_south[t1], 3)` (`r round(q_south_sd[t1], 3)`) | `r round(q_4x[t1], 3)` (`r round(q_4x_sd[t1], 3)`) |
