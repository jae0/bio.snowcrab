...
This is a Markdown document ... To create HTML or PDF, etc, run: 
  ...
  make quarto FN=snowcrab_working YR=2023 SOURCE=~/projects/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/reports # {via Quarto}

  make rmarkdown FN=snowcrab_working YR=2023 SOURCE=~/projects/bio.snowcrab/inst/markdown WK=~/bio.data/bio.snowcrab/reports {via Rmarkdown}
