...
This is a RMarkdown document designed to render a PDF document. Run:
  ...
  make snowcrab_working paper YR=2023  SOURCE~/bio/bio.snowcrab/inst/markdown WK=~/bio/bio.data/bio.snowcrab/reports 

Other options are at the top of the Makefile (SOURCE, )
