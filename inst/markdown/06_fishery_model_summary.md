...
Summary 4 of 4 -- This file is designed to create an HTML document that describes and summarizes the assessment of stock status. 
 
make quarto FN=06_fishery_model_summary.md YR=2025 MAU=region DATADIR=~/bio.data/bio.snowcrab DOCTYPE=html PARAMS="-P year_assessment:2025 -P todo:[fishery_results,fishery_model]" --directory=~/bio/bio.snowcrab/inst/markdown
