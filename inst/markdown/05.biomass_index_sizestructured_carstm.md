...
# -------------------------------------------------
  /home/jae/projects/dynamical_model/snowcrab/data/default_M0/carstm_inputs.RDS
...
carstm_directory = file.path( homedir, "projects", "dynamical_model", "snowcrab", "data" )
...
for (snowcrab_filter_class in c(  "M0", "M1", "M2", "M3", "M4", "f.mat" ) ) {
  ...
  model_results_directory = file.path(carstm_directory, carstm_model_label)
  ...
  sppoly = areal_units( p=pN, areal_units_directory=model_results_directory )
