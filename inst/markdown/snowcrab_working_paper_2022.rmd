...
To generate output, copy this file and the media directory to work/report location, such as:
  ...
  ~/bio.data/bio.snowcrab/reports/ 

Then run the following in R:

  fnmd = "snowcrab_presentation_2023_general_summary.rmd"
  sourcedir = file.path( "~", "bio", "bio.snowcrab", "inst", "markdown")
  destdir = file.path( "~", "bio.data", "bio.snowcrab", "reports")

  file.copy( from=file.path(sourcedir, fnmd ), to=file.path(destdir, fnmd), recursive=TRUE )
