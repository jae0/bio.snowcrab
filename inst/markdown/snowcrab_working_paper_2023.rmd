...
To generate output, copy this file and the media directory to work/report location, such as:
...
Eg., run the following in R:
  ...
  fnmd = paste( ID, "_", year.assessment, ".rmd", sep="" )
  ...
  fn_wdoc_rmd  = file.path( destdir, fnmd )
  ...
  rmarkdown::render( fn_wdoc_rmd, params=pm, output_dir=destdir )
