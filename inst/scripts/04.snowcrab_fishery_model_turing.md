...
```R
  ...
  file.copy( file.path(julia_scripts_location, "snowcrab_startup.jl"), work_dir )
  file.copy( file.path(julia_scripts_location, "logistic_discrete_functions.jl"), work_dir )
  file.copy( file.path(julia_scripts_location, "logistic_discrete.jl"), work_dir )
