...
theta_init = list(
  ...
  M4=list( 
    N = c(1.310,   2.455, 1.281, 2.345,   3.802, 3.703,   3.988, 5.086,   1.218, -3.242,  0.201, -3.865, 0.786),
  ...
  f.mat=list(
    ...
    H = c(0.931, 1.269, -0.229, 1.815,  -4.117, 5.398, 4.586,   -0.764, -5.055, -0.530, -1.979, 2.484 )
  )
)
