...
<!-- Copy this file to a work directory (e.g., bio.data/bio.snowcrab/reports/) and run Quarto from there (quarto render 51_bycatch.qmd --to html --to docx --to pdf )  -->
...
#| warning: false
#| error: false 
#| fig-cap: "Entanglement locations in Maritimes "
