...
<!-- Copy this file to a work directory (e.g., bio.data/bio.snowcrab/reports/) and run Quarto from there (quarto render 51_bycatch.qmd --to html) -->
...
o$bycatch_table[ o$bycatch_table==0 ] = "."
o$bycatch_table[ o$bycatch_table=="NaN" ] = "."
...
```{r}
#| label: bycatch_all
#| tbl-cap: "At sea observed bycatch estimates based upon effort rescaling of Maritimes Region snow crab fishery."
...
#| tbl-cap: "At sea observed bycatch estimates based upon catch rescaling of Maritimes Region snow crab fishery."
...
#| warning: false
#| error: false 
#| fig-cap: "Entanglemen locations in Maritimes "
...
```{r}
#| label: bycatch_NENS
#| tbl-cap: "At sea observed bycatch estimates based upon effort rescaling of NENS snow crab fishery."
gt::gt(o$bycatch_table) |> 
  gt::tab_options(table.font.size = 12, data_row.padding = gt::px(1), 
    summary_row.padding = gt::px(1), grand_summary_row.padding = gt::px(1), 
    footnotes.padding = gt::px(1), source_notes.padding = gt::px(1), 
...
#| tbl-cap: "At sea observed bycatch estimates based upon catch rescaling of NENS snow crab fishery."
gt::gt(o$bycatch_table_catch) |> 
  gt::tab_options(table.font.size = 12, data_row.padding = gt::px(1), 
    summary_row.padding = gt::px(1), grand_summary_row.padding = gt::px(1), 
    footnotes.padding = gt::px(1), source_notes.padding = gt::px(1), 
...
```{r}
#| label: bycatch_SENS
#| tbl-cap: "At sea observed bycatch estimates based upon effort rescaling of SENS snow crab fishery."
gt::gt( o$bycatch_table ) |> 
  gt::tab_options(table.font.size = 12, data_row.padding = gt::px(1), 
    summary_row.padding = gt::px(1), grand_summary_row.padding = gt::px(1), 
    footnotes.padding = gt::px(1), source_notes.padding = gt::px(1), 
...
#| tbl-cap: "At sea observed bycatch estimates based upon catch rescaling of SENS snow crab fishery."
gt::gt( o$bycatch_table_catch ) |> 
  gt::tab_options(table.font.size = 12, data_row.padding = gt::px(1), 
    summary_row.padding = gt::px(1), grand_summary_row.padding = gt::px(1), 
    footnotes.padding = gt::px(1), source_notes.padding = gt::px(1), 
...
```{r}
#| label: bycatch_4X
#| tbl-cap: "At sea observed bycatch estimates based upon effort rescaling of 4X snow crab fishery."
gt::gt(o$bycatch_table) |> 
  gt::tab_options(table.font.size = 12, data_row.padding = gt::px(1), 
    summary_row.padding = gt::px(1), grand_summary_row.padding = gt::px(1), 
    footnotes.padding = gt::px(1), source_notes.padding = gt::px(1), 
...
#| tbl-cap: "At sea observed bycatch estimates based upon catch rescaling of 4X snow crab fishery."
gt::gt(o$bycatch_table_catch) |> 
  gt::tab_options(table.font.size = 12, data_row.padding = gt::px(1), 
    summary_row.padding = gt::px(1), grand_summary_row.padding = gt::px(1), 
    footnotes.padding = gt::px(1), source_notes.padding = gt::px(1), 
