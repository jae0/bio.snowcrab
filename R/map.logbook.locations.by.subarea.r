  ...
  map.logbook.locations.by.subarea = function(p, basedir, years=NULL, regions=NULL, region_label ) {
    ...
    for (r in regions[["subarea"]]) {
        ...
        plt = ggplot( ) +
            geom_sf(data=y, aes( fill=year , col=year ), lwd=0, cex=7, alpha=0.5) +  
